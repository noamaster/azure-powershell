if(($null -eq $TestName) -or ($TestName -contains 'AzSphereImageandDepoymentScenario'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'AzSphereImageandDepoymentScenario.Recording.json'
