...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (InputObject?.Id != null)
                    {
                        ...
                        this.Update_body();
                        await this.Client.DataCollectionEndpointsCreateViaIdentity(InputObject.Id, _body, onOk, onCreated, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDataCollectionEndpoint_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDataCollectionEndpoint_UpdateViaIdentityExpanded()
        {
