...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByResourceGroup=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/dataCollectionEndpoints"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataCollectionEndpoint_List")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Description(@"Lists all data collection endpoints in the specified resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/dataCollectionEndpoints", ApiVersion = "2022-06-01")]
    public partial class GetAzDataCollectionEndpoint_List : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Runtime.IContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataCollectionEndpoint_List" /> cmdlet class.
        /// </summary>
        public GetAzDataCollectionEndpoint_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DataCollectionEndpointsListByResourceGroup(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.DataCollectionEndpointsListByResourceGroup_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
