...
namespace Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListByRule=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/dataCollectionRules/{dataCollectionRuleName}/associations"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzDataCollectionRuleAssociation_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Description(@"Lists associations for the specified data collection rule.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/dataCollectionRules/{dataCollectionRuleName}/associations", ApiVersion = "2022-06-01")]
    public partial class GetAzDataCollectionRuleAssociation_List1 : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Monitor.DataCollection.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="DataCollectionRuleName" /> property.</summary>
        private string _dataCollectionRuleName;
        ...
        public string DataCollectionRuleName { get => this._dataCollectionRuleName; set => this._dataCollectionRuleName = value; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzDataCollectionRuleAssociation_List1" /> cmdlet class.
        /// </summary>
        public GetAzDataCollectionRuleAssociation_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DataCollectionRuleAssociationsListByRule(SubscriptionId, ResourceGroupName, DataCollectionRuleName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,DataCollectionRuleName=DataCollectionRuleName})
                    {
                ...
                if (_isFirst)
                {
                    ...
                    while (!String.IsNullOrEmpty(_nextLink))
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.DataCollectionRuleAssociationsListByRule_Call(requestMessage, onOk, onDefault, this, Pipeline);
                        }
                    }
                }
            }
